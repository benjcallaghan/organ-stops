...
export class FirebaseuiAngularLibraryComponent implements OnInit, OnDestroy {
  ...
  signInSuccessWithAuthResultCallback: EventEmitter<FirebaseUISignInSuccessWithAuthResult> =
    new EventEmitter(); // tslint:disable-line
  @Output('signInFailure')
  signInFailureCallback: EventEmitter<FirebaseUISignInFailure> = new EventEmitter(); // tslint:disable-line
  ...
  constructor(
    ...
    @Inject('firebaseUIAuthConfig')
    private _firebaseUiConfig: NativeFirebaseUIAuthConfig,
    @Inject('firebaseUIAuthConfigFeature')
    private _firebaseUiConfig_Feature: NativeFirebaseUIAuthConfig,
  ...
  private getUIAuthConfig(): NativeFirebaseUIAuthConfig {
    if (!(this.firebaseUiConfig as NativeFirebaseUIAuthConfig).callbacks) {
      ...
      (this._firebaseUiConfig as NativeFirebaseUIAuthConfig).callbacks =
        this.getCallbacks();
    }
